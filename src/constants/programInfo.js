import logo from "../images/logo_usd.png" // add school logo to images folder and import here
...
export const faq = { // faq section
    ...
    loanRange: [
        {
            programName: "The University of San Diego Cyber Bootcamp",
            maxAmount: "$11,910",
            col: false,
            colAmount: "$6,000"
        }
...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its program to prepare its students with a foundation for a career in Cybersecurity. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        name: "Cyber Bootcamp",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKFSTT18",
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $11,910 for the University of San Diego's Cyber Bootcamp tuition."
